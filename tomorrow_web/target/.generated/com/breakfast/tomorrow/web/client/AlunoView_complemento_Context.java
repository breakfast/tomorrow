...
public class AlunoView_complemento_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.String> {
  private final com.breakfast.tomorrow.web.client.vo.AlunoVO parent;
  public AlunoView_complemento_Context(com.breakfast.tomorrow.web.client.vo.AlunoVO parent, com.google.gwt.editor.client.Editor<java.lang.String> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
  ...
  @Override public java.lang.String getFromModel() {
    return (parent != null && true) ? parent.getComplemento() : null;
  }
  @Override public void setInModel(java.lang.String data) {
    parent.setComplemento(data);
  }
}
