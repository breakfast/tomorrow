...
public class DisciplinaTest  {
	...
	public void testCrud(){
		...
		long id = disciplina.getIdDisciplina();
		Assert.assertNotSame("Insert Disciplina ", id, 0);	
		Disciplina encontrada = Disciplina.getDisciplinaPorId(id);
		Assert.assertNotNull("Disciplina nao encontrado! ",encontrada);
