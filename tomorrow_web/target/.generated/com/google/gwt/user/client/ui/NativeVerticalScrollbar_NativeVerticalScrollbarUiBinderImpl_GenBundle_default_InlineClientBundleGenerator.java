  ...
  private void styleInitializer() {
    style = new com.google.gwt.user.client.ui.NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_GenCss_style() {
      ...
      public String getText() {
        return (".GMOKSFJDOI{position:" + ("relative")  + ";overflow:" + ("hidden")  + ";direction:" + ("ltr")  + ";}.GMOKSFJDNI{position:" + ("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";height:" + ("100%")  + ";width:" + ("100px")  + ";overflow-y:" + ("scroll")  + ";overflow-x:" + ("hidden")  + ";}");
      }
